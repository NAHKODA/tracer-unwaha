	      ...
	      <div class="panel-body">
			...
			<form action ="simpan-step-1.php" method="POST" role="form">
			  ...
			  <div class="form-group">
			    ...
			    <textarea name="jumlahkaryawan" rows="3" class="form-control" id="jumlahkaryawan" placeholder="Contoh : 20 Orang" autocomplete="off"></textarea>
			  </div>

			  <div class="form-group">
			    <label for="komposisi">
			    	<span style="border-left: 3px solid #66AE53;"> &nbsp; Komposisi karyawan adalah sebagai berikut<span style="color:red">*</span></span>
			    </label>
			    <input type="text" name="karyawansarjana" class="form-control" id="hp" placeholder="Sarjana : 20 Orang" autocomplete="off">
			    <br>
			    <input type="text" name="karyawandiploma" class="form-control" id="hp" placeholder="Diploma : 20 Orang" autocomplete="off">
			    <br>
			    <input type="text" name="karyawansmpsmu" class="form-control" id="hp" placeholder="SMP - SMU : 20 Orang" autocomplete="off">
			  </div>
